  ...
  return (
    <div className="relative mr-0">
      <img
        ...
        alt="design-left"
        className="absolute opacity-[50%] h-[760px] md:h-[800px] md:w-auto left-0 top-1/2 transform  bg-sponsors-bg bg-cover bg-center overflow-hidden "
      />
      <div className="lg:px-20 my-5 z-10">
        <div>
