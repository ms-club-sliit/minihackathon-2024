  ...
  return (
    <>
      {PastWinnersData.data.map((winner) => (
        <div
          key={winner.id}
          className="grid grid-cols-1 md:grid-cols-2 mb-5  px-7 py-7 border-2 border-gray-200 rounded-3xl max-w-6xl mx-auto"
        >
          {winner.id % 2 === 0 ? (
            <>
              <div className="flex flex-col justify-center hidden md:block px-7">
